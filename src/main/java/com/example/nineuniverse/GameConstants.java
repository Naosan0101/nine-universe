...
public final class GameConstants {
	...
	/** おしらせ配布（新シーズン開幕） */
	public static final String ANNOUNCEMENT_NEW_SEASON_OPENING_2026_KEY = "new_season_opening_2026_06_27";

	public static final int ANNOUNCEMENT_NEW_SEASON_OPENING_2026_GEMS = 50;

	public static final LocalDate ANNOUNCEMENT_NEW_SEASON_OPENING_2026_START = LocalDate.of(2026, 6, 27);
