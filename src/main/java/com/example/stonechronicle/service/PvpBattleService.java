...
import com.example.stonechronicle.battle.PendingChoice;
import com.example.stonechronicle.pvp.PvpMatch;
import com.example.stonechronicle.web.dto.CpuBattleStateDto;
import com.example.stonechronicle.web.dto.PendingChoiceDto;
...
public class PvpBattleService {
	...
	private CpuBattleStateDto swapPerspective(CpuBattleStateDto b, CpuBattleState raw) {
		...
		com.example.stonechronicle.web.dto.PendingEffectDto pe = b.pendingEffect();
		com.example.stonechronicle.web.dto.PendingEffectDto npe = null;
		if (pe != null) {
			npe = new com.example.stonechronicle.web.dto.PendingEffectDto(
					!pe.ownerHuman(),
					pe.mainInstanceId(),
					pe.cardId(),
