...
UPDATE card_definition SET deploy_help = 'お互いのプレイヤーは、手札からカードを1枚選んで、レストゾーンに置く。', passive_help = NULL WHERE id = 5;
...
UPDATE card_definition SET deploy_help = NULL, passive_help = '自分が所持しているストーン1つにつき、相手のファイターの強さ-1。' WHERE id = 8;
...
UPDATE card_definition SET deploy_help = '次に自分がバトルゾーンに配置するファイターの強さに+1。', passive_help = NULL WHERE id = 11;
