...
(16, 'ピクシー', 0, 1, 'ELF', 'きのこ拾い.PNG', 'KINOKO', NULL, '自分のレストから1枚選び手札へ', NULL),
...
(22, 'ふわふわゴースト', 1, 3, 'UNDEAD', 'ふわふわゴースト.PNG', 'FUWAFUWA', NULL, '任意でストーン1消費。使用時、次の自分ターン開始までレストに行かず手札へ', NULL),
(23, 'ネクロマンサー', 1, 2, 'UNDEAD', '二度寝ゾンビ.PNG', 'NIDONEBI', NULL, '任意でストーン1消費。使用時、レストにがいこつ兵がいればデッキ最下段へ', NULL),
...
(27, 'ドラゴンの卵', 0, 0, 'DRAGON', 'ドラゴンの卵.PNG', 'RYUNOTAMAGO', NULL, '任意でストーン2消費。使用時、レストのドラゴン1枚を手札へ', NULL),
...
(30, '竜王', 1, 6, 'DRAGON', '竜王.PNG', NULL, 'RYUOH', NULL, '相手ファイターは配置・常時能力が無効');
