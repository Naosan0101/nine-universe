...
VALUES
	...
	(35, 'クリスタクル', 0, 0, 'CARBUNCLE', 'FIGHTER', '__missing__.PNG', 'R', 'JU', NULL, NULL, '自分のレストゾーンに「種族：カーバンクル」があるなら、ストーンを2つ使用してもよい。使用したなら、ストーンを5つ得る。', NULL),
	...
	(38, 'フェザリア', 0, 3, 'CARBUNCLE', 'FIGHTER', '__missing__.PNG', 'Ep', 'JU', NULL, NULL, 'ストーンを2つ使用してもよい。使用したなら、自分のレストゾーンから「種族：カーバンクル」のカードを2枚まで選んで、手札に加える。', NULL),
	(39, 'ルミナンク', 2, 1, 'CARBUNCLE', 'FIGHTER', '__missing__.PNG', 'R', 'JU', NULL, NULL, '自分が所持しているストーンの数を2倍にする。', NULL),
	(40, 'ネムリィ', 4, 1, 'CARBUNCLE', 'FIGHTER', '__missing__.PNG', 'Ep', 'JU', NULL, NULL, NULL, '自分のレストゾーンの「種族：カーバンクル」の枚数だけコストを-する。相手のターンの間、強さ+5。'),
	(41, '宝石の地 グロリア輝石台地', 1, 0, 'CARBUNCLE', 'FIELD', '__missing__.PNG', 'Ep', 'JU', NULL, NULL, '〈フィールド〉「種族：カーバンクル」のファイターの強さを常に+2する。', NULL),
	(42, '探鉱の洞窟 ネビュラ坑道', 1, 0, 'CARBUNCLE', 'FIELD', '__missing__.PNG', 'R', 'JU', NULL, NULL, '〈フィールド〉「種族：カーバンクル」のファイターを配置するたびに、ストーンを1つ得る。', NULL),
...
VALUES
	...
	(56, 'SPEC-0', 0, 2, 'MACHINE', 'FIGHTER', '__missing__.PNG', 'R', 'IF', NULL, NULL, '自分のレストゾーンの「もとの強さが1」のファイターを1枚選んで、デッキの一番上に置く。', NULL),
	...
	(60, 'ガラクタアーム', 0, 1, 'MACHINE', 'FIGHTER', '__missing__.PNG', 'C', 'IF', NULL, NULL, NULL, '相手のターンの間、強さ+1。'),
